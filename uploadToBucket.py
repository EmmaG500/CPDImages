...
for image in imagesArr:
  s3.meta.client.upload_file(image, 'cwbuckets2026816', ('image'+str(index)+image[-4:])) # uploads file with a name of image, the image number, and then the image extension
  index+=1
